    ...
    <div
        ...
        x-data="{
            ...
            selectCategory(cat) {
                ...
                if (this.materialsMap[cat] && this.materialsMap[cat].length > 0) {
                    this.materialType = this.materialsMap[cat][0];
                }
            }
        }"
        ...
        <form action="#" method="POST" @submit.prevent="alert('Quote submitted!'); quoteOpen = false;" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="space-y-5 pt-2">
                    ...
                    <!-- Contact Details (Common to both modes) -->
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <template x-for="mat in Object.keys(materialsMap)">
                                        <button type="button" @click="selectCategory(mat)" :class="materialCat === mat ? 'bg-indigo-500/20 text-indigo-300 border-indigo-500' : 'bg-zinc-950 text-zinc-400 border-zinc-800 hover:border-zinc-700 hover:text-zinc-200'" class="px-3 py-1.5 border rounded-lg text-xs font-medium transition-all" x-text="mat"></button>
                                    </template>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <template x-for="t in materialsMap[materialCat] || []">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-zinc-300 mb-2"><span class="text-rose-500">*</span> Printing Technology:</label>
                                    <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/30 rounded-lg text-xs font-medium text-emerald-400">
